...
class MechbrainOrderDatailsVC: UIViewController {
    ...
    var MechbrainSerVCDelegate: MechbrainServicesCatVCDelegate? = nil
    ...
    func APICALLS(){
        let OrderId = UserDefaults.standard.string(forKey: "MBOrderID") ?? ""
    ...
    @objc func backBtnPressed(){
        ...
        MechbrainSerVCDelegate?.MechbrainNavigationBack()
    }
    ...
    @objc func ProceedToPayment(){
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "MechbrainPaymentSummaryVC") as! MechbrainPaymentSummaryVC
...
extension MechbrainOrderDatailsVC : UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 2:
            if let cell = tableView.dequeueReusableCell(withIdentifier: "OrderTrackingDetailsTVC") as? OrderTrackingDetailsTVC {
                cell.selectionStyle = .none
                cell.OrderArrivedLbl.text = "Order Arrived"
                ...
                if self.OrderServices.count > 0 {
                    ...
                    if OrderDetails?.payment == true{
                        ...
                        if self.OrderDetails?.discount == "0"{
                            cell.PaidAmount.text = "Rs.\(self.OrderDetails?.totalAmount ?? "").0"
                        } else{
...
extension MechbrainOrderDatailsVC{
    func getOrderDetails(orderId: String){
        ...
        if Connectivity.isConnectedToInternet
        {
            ...
            Alamofire.request(APIEndPoints.mechbrainOrderDetails, method: .post, parameters: params, encoding: JSONEncoding.default, headers: nil).responseJSON { apiResponse in
