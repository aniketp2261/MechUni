//
//  MechbrainProviderDetailsVC.swift
//  ValetParking
//
...
struct MechbrainGetServicesByProviderModel {
...
struct MechbrainProviderServicesModel {
...
class MechbrainProviderDetailsVC: UIViewController {
    ...
    var MechbrainProviderDetailsSerVCDelegate: MechbrainServicesCatVCDelegate? = nil
    var ProviderID: String = ""
    var ProviderDetails: [MechbrainGetServicesByProviderModel] = []
    var ServicesData: [MechbrainProviderServicesModel] = []
    ...
    @objc func backAction(){
        ...
        MechbrainProviderDetailsSerVCDelegate?.MechbrainNavigationBack()
    }
...
extension MechbrainProviderDetailsVC: ImageSlideshowDelegate {
    func imageSlideshow(_ imageSlideshow: ImageSlideshow, didChangeCurrentPageTo page: Int) {
//        print("Current Page:", page)
    }
}
extension MechbrainProviderDetailsVC: UITableViewDelegate, UITableViewDataSource{
...
extension MechbrainProviderDetailsVC{
    func ProviderDetailsAPI(id: String){
        ...
        if Connectivity.isConnectedToInternet
        {
            ...
            Alamofire.request(APIEndPoints.mechbrainServicesProvider,method: .post,parameters: params,encoding: JSONEncoding.default,headers: nil).responseJSON { apiResponse in
                        ...
                        if status == "success" {
                            ...
                            if let result = results{
                                ...
                                for data2 in serviceList{
                                    ...
                                    let model = MechbrainProviderServicesModel(id: id, serviceId: serviceId, providerId: providerId, cartId: cartId, serviceCost: serviceCost, serviceName: serviceName, categoryName: categoryName, vehicleType: vehicleType, pickupAvailable: pickupAvailable, addedinCart: addedInCart, servicesImages: servicesImages)
                                    self.ServicesData.append(model)
                                }
                                let model = MechbrainGetServicesByProviderModel(serviceList: serviceList, pickupavai: pickup, userName: userName, image: image, email: email, start_opening_hours: startOpeningHours, end_opening_hours: endOpeningHours, mobilenumber: mobileNumber, provider_id: providerId, address: address, lat: lat, long: long, companyId: companyId)
...
extension MechbrainProviderDetailsVC: SFSafariViewControllerDelegate{
