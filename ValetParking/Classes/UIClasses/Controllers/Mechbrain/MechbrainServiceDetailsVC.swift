//
//  MechbrainServiceDetailsVC.swift
//  ValetParking
//
...
struct MechbrainServicesByServiceModel {
...
class MechbrainServiceDetailsVC: UIViewController {
    ...
    var serviceDetails: [MechbrainServicesByServiceModel] = []
    var otherServices: [MechbrainOtherServicesModel] = []
    ...
    override func viewDidLoad() {
        ...
        OtherServicesTV.separatorStyle = .none
        OtherServicesTV.estimatedRowHeight = 80
        OtherServicesTV.rowHeight = UITableView.automaticDimension
        OtherServicesTV.register(UINib(nibName: "ProviderServicesTVC", bundle: nil), forCellReuseIdentifier: "ProviderServicesTVC")
...
extension MechbrainServiceDetailsVC : UITableViewDelegate, UITableViewDataSource{
...
extension MechbrainServiceDetailsVC: ImageSlideshowDelegate {
    func imageSlideshow(_ imageSlideshow: ImageSlideshow, didChangeCurrentPageTo page: Int) {
        print("current page:", page)
    }
}
extension MechbrainServiceDetailsVC {
    func ServiceDetailsAPI(serviecId: String, providerId: String){
        ...
        if Connectivity.isConnectedToInternet
        {
            ...
            Alamofire.request(APIEndPoints.mechbrainServiceDetailByService,method: .post,parameters: params,encoding: JSONEncoding.default,headers: nil).responseJSON { apiResponse in
                print("MechServiceDetailsAPIRes ----- \(apiResponse)")
                    ...
                    if let apiDict = apiResponse.value as? [String:Any]{
                        ...
                        if status == "success" {
                            ...
                            for other in otherServices{
                                ...
                                let model = MechbrainOtherServicesModel(serviceImages: serviceImages, id: id, cartId: cartId, serviceId: serviceId, providerId: providerId, serviceCost: serviceCost, serviceName: serviceName, categoryName: categoryName, vehicleType: vehicleType, pickupAvailable: pickupAvailable, addedInCart: addedInCart)
...
extension MechbrainServiceDetailsVC: SFSafariViewControllerDelegate{
