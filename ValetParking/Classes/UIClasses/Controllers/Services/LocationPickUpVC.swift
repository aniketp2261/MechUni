...
class LocationPickUpVC: UIViewController, GMSMapViewDelegate, CLLocationManagerDelegate {
...
extension LocationPickUpVC: GMSAutocompleteViewControllerDelegate {
