...
struct SearchServiceModel {
    let id, image, address, startOpeningHours, endOpeningHours, vehicleType, categoryId, name, description, type : String
}
...
class SearchServicesVC: UIViewController {
    ...
    func searchServicesAPI(searchName:String){
        ...
        {
            Alamofire.request(APIEndPoints.searchServices, method: .post,parameters: params,headers: nil).responseJSON { apiResponse in
...
extension SearchServicesVC : UITableViewDelegate, UITableViewDataSource{
