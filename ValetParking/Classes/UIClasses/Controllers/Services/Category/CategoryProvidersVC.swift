...
class CategoryProvidersVC: UIViewController {
...
class CategoryProvidersSortTVC: UITableViewCell{
    @IBOutlet weak var radImg: UIImageView!
    @IBOutlet weak var sortLbl: UILabel!
}
extension CategoryProvidersVC : UITableViewDelegate, UITableViewDataSource{
...
extension CategoryProvidersVC{
    func getProviderList(ServiceId:String, lat:String, long:String, sortBy: Int){
        ...
        {
            Alamofire.request(APIEndPoints.getProvidersByService,method: .post,parameters: params, encoding: JSONEncoding.default,headers: nil).responseJSON { apiResponse in
