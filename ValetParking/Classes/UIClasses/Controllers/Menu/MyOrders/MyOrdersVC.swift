...
struct OrderListModel{
    let id, orderID, customerId, providerId, orderStatus, orderAmount, createdAt, providerAddr, providerName, providerImage, vehicleId, vehicleNo, vehicleType: String
    let orderConfirm, orderPickup, inprogress, completed, payment : Bool
}
struct OrderItemsModel{
...
class MyOrdersVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(backBtnPressed))
